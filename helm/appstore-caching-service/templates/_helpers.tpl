...
{{- define "appstore-caching-charts.name" -}}
{{- .Chart.Name | trunc 40 | trimSuffix "-" -}}
{{- end -}}

{{- define "appstore-caching-charts.appSuffix" -}}
{{- $globalAppSuffix := "" -}}
...
{{- define "appstore-caching-charts.fullname" -}}
{{- $appSuffix := include "appstore-caching-charts.appSuffix" . -}}
...
*/}}
{{- define "appstore-caching-charts.chart" -}}
